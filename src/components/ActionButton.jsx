  ...
  const renderForm = () => {
    ...
    return (
      <FlexContainer>
        ...
        <Buttongroup>
          <Button variant="contained" size="small" disableElevation style={{backgroundColor: "#2DA54E", color: "#fff"}}>{buttonTitle}</Button>
          <Button variant="outlined" size="small" disableElevation>Cancel</Button>
        </Buttongroup>
      </FlexContainer>
    )
  }
